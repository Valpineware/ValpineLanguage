...
A raw pointer to some type may be declared normally such as \tcode{T *p;}. Additionally, there are 4 types of built-in smart pointers that can be used: scoped, unique, shared, and weak. These modifiers can be assigned much like the \tcode{const} modifier.
...
\Sec2[intro.memory.scoped]{Scoped Pointer}
...
\Sec2[intro.memory.unique]{Unique Pointer}
...
\Sec2[intro.memory.shared]{Shared Pointer}
...
\Sec2[intro.memory.weak]{Weak Pointer}
