...
\usepackage[pdftex,
            pdftitle={Valpine Standard},
            pdfsubject={Valpine Standard},
            pdfcreator={Daniel Watkins},
            bookmarks=true,
...
\mainmatter
\setglobalstyles\textsl{•}

\include{content/intro}
\include{content/memory}
\include{content/functions}\textsl{•}
